...
Deno.serve(async(req:Request)=>{
  ...
  try{
    ...
    const redirectTo="https://sirro-central.vercel.app";
    const {data:linkData,error:linkErr}=await admin.auth.admin.generateLink({type:"recovery",email:authEmail,options:{redirectTo}});
